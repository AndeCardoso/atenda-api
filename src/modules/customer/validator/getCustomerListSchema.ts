...
import {
  customerColumnArray,
  customerFilterTypeArray,
} from "../constants/paramsType";

export const getCustomerListSchema = checkSchema({
  page: {
    optional: true,
    isInt: {
  ...
  filter: {
    ...
    isIn: {
      options: [customerFilterTypeArray],
      errorMessage: `Nome do filtro inválido, escolha entre os seguintes valores: ${customerFilterTypeArray.reduce(
